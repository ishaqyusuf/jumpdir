...
assert_contains "$output" "Current version: 0.3.5"
assert_contains "$output" "Latest version:  0.3.5"
...
assert_contains "$update_prompt_output" "Current version: 0.3.5"
...
assert_contains "$("$TMP_DIR/install-local/jumpdir" --version)" "jumpdir 0.3.5"
assert_contains "$("$TMP_DIR/install-local/jd" --version)" "jd 0.3.5"
assert_contains "$("$TMP_DIR/install-local/termcode" --version)" "termcode 0.3.5"
...
assert_contains "$("$TMP_DIR/install-remote/jumpdir" --version)" "jumpdir 0.3.5"
assert_contains "$("$TMP_DIR/install-remote/jd" --version)" "jd 0.3.5"
assert_contains "$("$TMP_DIR/install-remote/termcode" --version)" "termcode 0.3.5"
...
assert_contains "$("$TMP_DIR/install-piped/jumpdir" --version)" "jumpdir 0.3.5"
assert_contains "$("$TMP_DIR/install-piped/jd" --version)" "jd 0.3.5"
assert_contains "$("$TMP_DIR/install-piped/termcode" --version)" "termcode 0.3.5"
