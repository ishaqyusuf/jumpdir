...
- Updates: interactive startup skips help/version/update/history/completion/init, checks the published source version and content at most once per day, and can run the installer into the current binary directory when accepted.
